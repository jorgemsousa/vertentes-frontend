...
export default class tableClima extends Component {
  ...
  loadClimasp = async () => {
    const response = await apiClima.get(
      "/api/v1/weather/locale/3477/current?token=3c3e45f5ec0dfc955b9ef48d8e75ce69"
    );
  ...
  loadClimarj = async () => {
    const response = await apiClima.get(
      "/api/v1/weather/locale/5959/current?token=3c3e45f5ec0dfc955b9ef48d8e75ce69"
    );
  ...
  loadClimabh = async () => {
    const response = await apiClima.get(
      "/api/v1/weather/locale/6879/current?token=3c3e45f5ec0dfc955b9ef48d8e75ce69"
    );
  ...
  loadClimaba = async () => {
    const response = await apiClima.get(
      "/api/v1/weather/locale/7564/current?token=3c3e45f5ec0dfc955b9ef48d8e75ce69"
    );
  ...
  loadClimaam = async () => {
    const response = await apiClima.get(
      "/api/v1/weather/locale/7544/current?token=3c3e45f5ec0dfc955b9ef48d8e75ce69"
    );
    ...
    return (
      <div className="card text-white bg-info m-3">
        <div className="card-header text-center">
          <h3>Temperatura das Principais Cidades</h3>
        </div>
